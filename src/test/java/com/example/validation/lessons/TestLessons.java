...
public class TestLessons {
    ...
    void initObject(){
        ...
        lessonsService = new LessonsService(lessonsMapper, lessonsRepository, coursesRepository, modulesRepository);
    }
    ...
    void testCreatePositive(){
        ...
        ResponseDto<LessonsDto> responseDto =this.lessonsService.create(any());
    ...
    void testCreateException(){
        when(this.lessonsService.create(any()))
